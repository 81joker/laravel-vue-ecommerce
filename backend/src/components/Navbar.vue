<template>
    <header class="flex transition-all justify-between bg-white items-center p-3 h-14 shadow">
...
import { computed } from 'vue';
  ...
  const cruentUser = computed(() => store.state.user.data)
